...
function Inspect-RunCommand {
    Try {
        $results = @()

        $roles = Get-AzRoleDefinition | Where-Object { $_.Actions -contains 'Microsoft.Compute/virtualMachines/runCommand/write' } 
